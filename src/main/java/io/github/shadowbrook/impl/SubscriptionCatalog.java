...
public class SubscriptionCatalog {
   ...
   * @param registrationListener Vertx registration listener
   */
  public SubscriptionCatalog(
      RedissonClient redisson, RedisKeyFactory keyFactory, RegistrationListener registrationListener) {
  ...
  public SubscriptionCatalog(
    ...
    this(redisson, redisKeyFactory, registrationListener);
